...
call = aditmadzs
creator = ["u3f9368b361c13a29471be0c5e1551393"]
owner = ["u3f9368b361c13a29471be0c5e1551393"]
admin = ["u3f9368b361c13a29471be0c5e1551393"]
staff = ["u3f9368b361c13a29471be0c5e1551393"]
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           aditmadzs.sendMessage(msg.to,"已加入黑名單")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           aditmadzs.sendMessage(msg.to,"已從黑名單中去除")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     aditmadzs.sendMessage(msg.to, "helper OTW JOIN GROUP : %s" % str(group.name))
                                     group1 = ki.findGroupByTicket(ticket_id)
                                     ki.acceptGroupInvitationByTicket(group1.id,ticket_id)
                                     ki.sendMessage(msg.to, "helper OTW JOIN GROUP : %s" % str(group.name))
                                     group2 = kk.findGroupByTicket(ticket_id)
                                     kk.acceptGroupInvitationByTicket(group2.id,ticket_id)
                                     kk.sendMessage(msg.to, "helper OTW JOIN GROUP : %s" % str(group.name))
                                     group3 = kc.findGroupByTicket(ticket_id)
                                     kc.acceptGroupInvitationByTicket(group3.id,ticket_id)
                                     kc.sendMessage(msg.to, "helper OTW JOIN GROUP : %s" % str(group.name))
